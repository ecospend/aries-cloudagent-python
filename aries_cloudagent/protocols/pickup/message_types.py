...
DELETE_PICKUP_REQUEST = f"{PROTOCOL_URI}/delete-request"
DELETE_PICKUP_RESPONSE = f"{PROTOCOL_URI}/delete-response"
...
NEW_LIST_PICKUP_REQUEST = f"{NEW_PROTOCOL_URI}/list_pickup_request"
NEW_LIST_PICKUP_RESPONSE = f"{NEW_PROTOCOL_URI}/list_pickup_response"
NEW_DELETE_PICKUP_REQUEST = f"{NEW_PROTOCOL_URI}/delete-request"
NEW_DELETE_PICKUP_RESPONSE = f"{NEW_PROTOCOL_URI}/delete-response"
...
MESSAGE_TYPES = {
    ...
    DELETE_PICKUP_REQUEST: (
        f"{PROTOCOL_PACKAGE}.messages.delete_pickup_request.DeletePickupRequest"
    ),
    DELETE_PICKUP_RESPONSE: (
        f"{PROTOCOL_PACKAGE}.messages.delete_pickup_response.DeletePickupResponse"
    ),
    NEW_STATUS_REQUEST: (
        f"{PROTOCOL_PACKAGE}.messages.status_request.StatusRequest"
    ),
    ...
    NEW_DELETE_PICKUP_REQUEST: (
        f"{PROTOCOL_PACKAGE}.messages.delete_pickup_request.DeletePickupRequest"
    ),
    NEW_DELETE_PICKUP_RESPONSE: (
        f"{PROTOCOL_PACKAGE}.messages.delete_pickup_response.DeletePickupResponse"
    ),
}
